...
using ZNCHANY.Api.RequestPayload.Rbac.Menu;
using ZNCHANY.Api.ViewModels.Rbac.DncMenu;
...
namespace ZNCHANY.Api.Controllers.Api.V1.Rbac
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class MenuController : ControllerBase
    {
        ...
        public MenuController(ZNCHANYDbContext dbContext, IMapper mapper)
        {
