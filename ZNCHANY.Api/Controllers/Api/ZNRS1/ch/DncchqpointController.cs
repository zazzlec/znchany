...
using ZNCHANY.Api.RequestPayload.Rbac.Chqpoint;
using ZNCHANY.Api.ViewModels.Rbac.Dncchqpoint;
...
namespace ZNCHANY.Api.Controllers.Api.ZNCHANY1
{
    ...
    public class DncchqpointController : ControllerBase
    {
        ...
        public DncchqpointController(ZNCHANYDbContext dbContext, IMapper mapper)
        {
