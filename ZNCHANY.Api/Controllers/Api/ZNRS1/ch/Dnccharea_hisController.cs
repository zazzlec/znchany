...
using ZNCHANY.Api.RequestPayload.Rbac.Charea_his;
using ZNCHANY.Api.ViewModels.Rbac.Dnccharea_his;
...
namespace ZNCHANY.Api.Controllers.Api.ZNCHANY1
{
    ...
    public class Dnccharea_hisController : ControllerBase
    {
        ...
        public Dnccharea_hisController(ZNCHANYDbContext dbContext, IMapper mapper)
        {
        ...
        public IActionResult Edit(Dnccharea_hisEditViewModel model)
        {
            ...
            using (_dbContext)
            {
                ...
                entity.NumberTo = model.NumberTo;
                entity.TwoHour = model.TwoHour;
                entity.NowNumber = model.NowNumber;
                entity.TotleNumber = model.TotleNumber;
                _dbContext.SaveChanges();
                return Ok(response);
            }
        }
