...
using ZNCHANY.Api.RequestPayload.Rbac.Chrunlist;
using ZNCHANY.Api.ViewModels.Rbac.Dncchrunlist;
...
namespace ZNCHANY.Api.Controllers.Api.ZNCHANY1
{
    ...
    public class DncchrunlistController : ControllerBase
    {
        ...
        public DncchrunlistController(ZNCHANYDbContext dbContext, IMapper mapper)
        {
