...
using ZNCHANY.Api.RequestPayload.Rbac.Windgroup;
using ZNCHANY.Api.ViewModels.Rbac.Dncwindgroup;
...
namespace ZNCHANY.Api.Controllers.Api.ZNCHANY1
{
    ...
    public class DncwindgroupController : ControllerBase
    {
        ...
        public DncwindgroupController(ZNCHANYDbContext dbContext, IMapper mapper)
        {
