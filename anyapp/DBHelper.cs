...
namespace SynZnrs
{
    public class DBHelper
    {
        ...
        private string m_dbs = "Data Source=127.0.0.1;Database=sg_znch_any;User ID=root;Password=123456;pooling=true;CharSet=utf8;port=3306;sslmode=none";//锦界现场

        //private string m_dbs = "Data Source=127.0.0.1;Database=sg_znch_any;User ID=root;Password=123;pooling=true;CharSet=utf8;port=3306;sslmode=none";//本地
